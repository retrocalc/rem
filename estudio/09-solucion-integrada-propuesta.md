...
## 9.1. Arquitectura conceptual del sistema

### 9.1.1. Enfoque de dominios especializados
...
### 9.1.2. Separación entre datos y reglas
...
### 9.1.3. Gestión del tiempo como dimensión fundamental
...
## 9.2. Abordaje de las problemáticas identificadas

### 9.2.1. Diversidad de estructuras (Sección 2.1)
...
### 9.2.2. Jerarquías administrativas (Sección 2.2)
...
### 9.2.3. Variabilidad normativa (Sección 2.3)
...
## 9.3. Mecanismos para cálculo retroactivo automático

### 9.3.1. Motor de cálculo histórico
...
### 9.3.2. Gestión de eventos con efecto retroactivo
...
## 9.4. Gestión de variabilidad normativa e institucional

### 9.4.1. Sistema de reglas configurables
...
### 9.4.2. Personalización por institución
...
### 9.4.3. Sistema de validación normativa
...
## 9.5. Resultados esperados y beneficios cuantificables

### 9.5.1. Métricas de eficiencia
...
### 9.5.2. Impacto en calidad de servicio
...
### 9.5.3. Beneficios institucionales estratégicos
...
## 9.6. Implementación de referencia: Sistema actual

### 9.6.1. Componentes implementados
...
### 9.6.2. Casos de éxito iniciales
...
**Próximo capítulo**: [10. Implementación y Adopción](10-implementacion-adopcion.md)
